...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-[#2C324a] p-4 shadow fixed w-full z-50">
        <div className="flex justify-between items-center">
          {/* Left: Logo */}
          <Link href="/">
            <Image
              src="/images/Decode-Logo-Green.png"
          ...
          >
            <ul className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-6">
              <li className="flex items-center text-lg font-semibold text-white transition-colors duration-300 hover:text-[#33ff00]">
