    ...
    return (
        <section className="py-12 px-4 text-center">
            ...
            <div className="max-w-3xl mx-auto">
                <p className="mb-6">Decode Africa&rsquo;s consultation service helped us navigate the complexities of entering the Nigerian market. Their expert advice was invaluable in securing our first major client. - John Mwangi, Founder of TechStart Africa</p>
